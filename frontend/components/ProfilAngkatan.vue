    ...
    <div class="container mx-auto px-4">
      ...
      <div class="max-w-md mx-auto mb-12">
        <input 
          ...
          class="w-full px-6 py-4 rounded-md border-2 border-gray-200 bg-white text-gray-900 focus:border-green-500 focus:outline-none text-center font-bold placeholder:text-gray-400 transition-colors"
        >
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
        ...
        >
          <div class="bg-white rounded-xl overflow-hidden shadow-xl border-2 border-gray-200 hover:border-green-500 transition-colors duration-300">
            <div class="relative aspect-square overflow-hidden bg-gray-100">
              ...
              <div class="absolute top-4 right-4">
                <span 
                  class="px-3 py-1 rounded-md text-xs font-bold shadow-lg tracking-wider uppercase"
            ...
            <div class="p-6">
              <h3 class="text-xl font-black text-gray-900 mb-2 group-hover:text-green-500 transition-colors">
                {{ student.name }}
              </h3>
              
              <p class="text-sm font-bold text-green-500 mb-4 uppercase tracking-wider">
                {{ student.role }}
              </p>
